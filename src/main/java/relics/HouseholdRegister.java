...
public class HouseholdRegister extends CustomRelic {
    ...
    private static final String IMG = "img/relics_Seles/HouseholdRegister.png";
    private static final String IMG_OTL = "img/relics_Seles/outline/HouseholdRegister.png";
