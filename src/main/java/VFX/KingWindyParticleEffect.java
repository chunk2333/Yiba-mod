...
public class KingWindyParticleEffect extends AbstractGameEffect {
    ...
    public KingWindyParticleEffect(Color setColor, boolean reverse) {
        King = ImageMaster.loadImage("img/VFX/KING.png");
        if (!reverse) {
        ...
        this.y = MathUtils.random(0.15F, 0.85F) * Settings.HEIGHT - 128.0F;
    ...
    public KingWindyParticleEffect() {
        King = ImageMaster.loadImage("img/VFX/KING.png");
        this.x = MathUtils.random(-400.0F, -100.0F) * Settings.scale - 128.0F;
        this.y = MathUtils.random(0.15F, 0.85F) * Settings.HEIGHT - 128.0F;
        this.vX = MathUtils.random(1500.0F, 2500.0F) * Settings.scale;
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(King, this.x, this.y, 128.0F, 128.0F, 256.0F, 256.0F, this.scale *

                MathUtils.random(0.7F, 1.3F), this.scaleY *
                MathUtils.random(0.7F, 1.3F), this.rotation, 0, 0, 256, 256, false, false);
