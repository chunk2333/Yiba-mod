...
import cards.colorless.MagicGreenStone;
import cards.colorless.MagicRedStone;
import cards.colorless.MagicWhiteStone;
import cards.colorless.MagicYellowStone;
...
public class MagicStoneMiningAction extends AbstractGameAction {

    private boolean retrieveCard = false;

    private AbstractCard.CardType cardType = null;

    public MagicStoneMiningAction(int amount){
        this.amount = amount;
    ...
    public void update() {
        ...
        //ArrayList generatedCards = null;
        generatedCards.add(0, new MagicRedStone());
        generatedCards.add(1, new MagicGreenStone());
        generatedCards.add(2, new MagicYellowStone());
        generatedCards.add(3, new MagicWhiteStone());
