...
public class ElementCardPotionsAction extends AbstractGameAction {

    private boolean retrieveCard = false;

    private AbstractCard.CardType cardType = null;

    public ElementCardPotionsAction(int amount){
        this.amount = amount;
    ...
    public void update() {
        ...
        //generatedCards.add(0,YiBaHelper.getRandomElementCard());
        //generatedCards.add(1,YiBaHelper.getRandomElementCard());
        //generatedCards.add(2,YiBaHelper.getRandomElementCard());
    ...
    private ArrayList<AbstractCard> generateCardChoices() {
        ...
        while(derp.size() != 3) {
            ...
            tmp = YiBaHelper.getRandomElementCard();
