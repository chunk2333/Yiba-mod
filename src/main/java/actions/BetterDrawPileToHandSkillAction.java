...
public class BetterDrawPileToHandSkillAction extends AbstractGameAction {
    ...
    public BetterDrawPileToHandSkillAction(int numberOfCards, boolean optional) {
    ...
    public BetterDrawPileToHandSkillAction(int numberOfCards) {
        ...
        public void update () {
            ...
            if (this.duration == this.startDuration) {
                if (this.player.drawPile.isEmpty() || this.numberOfCards <= 0 ||skillCardNum <= 0) {
                    this.isDone = true;
                    return;
                }
