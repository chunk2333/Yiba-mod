 ...
 public class selesMod implements RelicGetSubscriber, PostPowerApplySubscriber, PostExhaustSubscriber, PostBattleSubscriber, PostDungeonInitializeSubscriber, EditCharactersSubscriber, PostInitializeSubscriber, EditRelicsSubscriber, EditCardsSubscriber, EditStringsSubscriber, OnCardUseSubscriber, EditKeywordsSubscriber, OnPowersModifiedSubscriber, PostDrawSubscriber, PostEnergyRechargeSubscriber {
   ...
   public void receiveEditRelics() {
       ...
       BaseMod.addRelic(new homa(),RelicType.SHARED);     //护摩滞胀
       ...
       BaseMod.addRelic(new APaTea(),RelicType.SHARED); //apacha
       ...
       //BaseMod.addMonsterEncounter(Exordium.ID,new MonsterInfo(YuanPi.ID, 5));
   ...
   public void receivePostInitialize() {
       ...
       //三幻批
       BaseMod.addMonster("SanHuanPi", () -> new MonsterGroup(new AbstractMonster[] {
               new YuanPi(200F,-20F),
               new ZhouPi(-150F,-20),
               new NongPi(-500F,-20)
       }));
       ...
       //UpdateStats.logger.info("添加音频文件:");
       //BaseMod.addAudio("HomoVoice","audio/HomoVoice.ogg");
       //BaseMod.addAudio("HomoVoice1","audio/HomoVoice.mp3");
       //BaseMod.addAudio("HomoVoice2","src/main/resources/audio/HomoVoice.ogg");
       //BaseMod.addAudio("HomoVoice3","src/main/resources/audio/HomoVoice.mp3");
       //SoundMaster
   }
