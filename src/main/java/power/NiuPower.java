...
public class NiuPower extends AbstractPower {
    public static final String POWER_ID = YibaMod.makeModID("NiuPower");

    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);

    public static TextureAtlas atlas_self;

    public NiuPower(AbstractCreature owner, int amount){
        ...
        this.region48 = atlas_self.findRegion("48/Niu");
        this.region128 = atlas_self.findRegion("128/Niu");
