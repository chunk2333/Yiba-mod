...
public class PotentialLiberation extends CustomCard {
    ...
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings("PotentialLiberation");
    ...
    public static final String ID = "PotentialLiberation";
